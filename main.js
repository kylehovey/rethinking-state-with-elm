...
var $author$project$Model$Card$ByRank = {$: 'ByRank'};
...
var $author$project$Main$DeckGenerated = function (a) {
	return {$: 'DeckGenerated', a: a};
};
...
var $author$project$Model$Card$Ace = {$: 'Ace'};
var $author$project$Model$Card$Eight = {$: 'Eight'};
var $author$project$Model$Card$Five = {$: 'Five'};
var $author$project$Model$Card$Four = {$: 'Four'};
var $author$project$Model$Card$Jack = {$: 'Jack'};
var $author$project$Model$Card$King = {$: 'King'};
var $author$project$Model$Card$Nine = {$: 'Nine'};
var $author$project$Model$Card$Queen = {$: 'Queen'};
var $author$project$Model$Card$Seven = {$: 'Seven'};
var $author$project$Model$Card$Six = {$: 'Six'};
var $author$project$Model$Card$Ten = {$: 'Ten'};
var $author$project$Model$Card$Three = {$: 'Three'};
var $author$project$Model$Card$Two = {$: 'Two'};
var $author$project$Model$Card$allRanks = _List_fromArray(
	[$author$project$Model$Card$Two, $author$project$Model$Card$Three, $author$project$Model$Card$Four, $author$project$Model$Card$Five, $author$project$Model$Card$Six, $author$project$Model$Card$Seven, $author$project$Model$Card$Eight, $author$project$Model$Card$Nine, $author$project$Model$Card$Ten, $author$project$Model$Card$Jack, $author$project$Model$Card$Queen, $author$project$Model$Card$King, $author$project$Model$Card$Ace]);
var $author$project$Model$Card$Club = {$: 'Club'};
var $author$project$Model$Card$Diamond = {$: 'Diamond'};
var $author$project$Model$Card$Heart = {$: 'Heart'};
var $author$project$Model$Card$Spade = {$: 'Spade'};
var $author$project$Model$Card$allSuits = _List_fromArray(
	[$author$project$Model$Card$Spade, $author$project$Model$Card$Club, $author$project$Model$Card$Heart, $author$project$Model$Card$Diamond]);
...
var $author$project$Model$Card$Card = F3(
	function (id, suit, rank) {
...
var $author$project$Model$Deck$mkCard = F2(
	function (suit, rank) {
		return A2(
			$elm$random$Random$map,
			function (uuid) {
				return A3($author$project$Model$Card$Card, uuid, suit, rank);
			},
...
var $author$project$Model$Util$sequenceRandom = A2(
	$elm$core$List$foldr,
	...
	var cardGen = A2(
		...
		function (suit) {
			return A2(
				$elm$core$List$map,
				function (rank) {
					return A2($author$project$Model$Deck$mkCard, suit, rank);
				},
				$author$project$Model$Card$allRanks);
		},
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		...
		$author$project$Main$generateDeck);
};
...
var $author$project$Model$Deck$discard = F2(
	function (selected, original) {
		var hand = original.hand;
		var discarded = original.discarded;
		var _v0 = A2(
			$elm$core$List$partition,
			function (_v1) {
				var id = _v1.id;
				return A2($Gizra$elm_all_set$EverySet$member, id, selected);
			},
			hand);
		var discardedCards = _v0.a;
		var newHand = _v0.b;
		return _Utils_update(
			original,
			{
				discarded: A2($elm$core$List$append, discarded, discardedCards),
				hand: newHand
			});
	});
...
var $author$project$Model$Card$rankMetadata = function (rank) {
	switch (rank.$) {
		case 'Ace':
			return _Utils_Tuple3('Ace', 0, 11);
		case 'Two':
			return _Utils_Tuple3('Two', 1, 2);
		case 'Three':
			return _Utils_Tuple3('Three', 2, 3);
		case 'Four':
			return _Utils_Tuple3('Four', 3, 4);
		case 'Five':
			return _Utils_Tuple3('Five', 4, 5);
		case 'Six':
			return _Utils_Tuple3('Six', 5, 6);
		case 'Seven':
			return _Utils_Tuple3('Seven', 6, 7);
		case 'Eight':
			return _Utils_Tuple3('Eight', 7, 8);
		case 'Nine':
			return _Utils_Tuple3('Nine', 8, 9);
		case 'Ten':
			return _Utils_Tuple3('Ten', 9, 10);
		case 'Jack':
			return _Utils_Tuple3('Jack', 10, 10);
		case 'Queen':
			return _Utils_Tuple3('Queen', 11, 10);
		default:
			return _Utils_Tuple3('King', 12, 10);
	}
};
var $author$project$Model$Util$third3 = function (_v0) {
	var c = _v0.c;
	return c;
};
var $author$project$Model$Card$rankToChips = A2($elm$core$Basics$composeL, $author$project$Model$Util$third3, $author$project$Model$Card$rankMetadata);
var $author$project$Model$Util$second3 = function (_v0) {
	var b = _v0.b;
	return b;
};
var $author$project$Model$Card$rankToOrder = A2($elm$core$Basics$composeL, $author$project$Model$Util$second3, $author$project$Model$Card$rankMetadata);
var $author$project$Model$Card$cardToRankOrder = function (_v0) {
	var rank = _v0.rank;
	var chips = $author$project$Model$Card$rankToChips(rank);
	var cardOrder = $author$project$Model$Card$rankToOrder(rank);
	return (chips * 100) + cardOrder;
};
...
var $author$project$Style$Colors$blue = A3($rtfeldman$elm_css$Css$rgb, 131, 165, 152);
var $author$project$Style$Colors$gray = A3($rtfeldman$elm_css$Css$rgb, 146, 131, 116);
var $author$project$Style$Colors$red = A3($rtfeldman$elm_css$Css$rgb, 251, 73, 52);
var $author$project$Style$Colors$yellow = A3($rtfeldman$elm_css$Css$rgb, 250, 189, 47);
var $author$project$Model$Card$suitMetadata = function (suit) {
	switch (suit.$) {
		case 'Spade':
			return _Utils_Tuple3('Spades', 0, $author$project$Style$Colors$gray);
		case 'Club':
			return _Utils_Tuple3('Clubs', 1, $author$project$Style$Colors$blue);
		case 'Heart':
			return _Utils_Tuple3('Hearts', 2, $author$project$Style$Colors$red);
		default:
			return _Utils_Tuple3('Diamonds', 3, $author$project$Style$Colors$yellow);
	}
};
var $author$project$Model$Card$suitToOrder = A2($elm$core$Basics$composeL, $author$project$Model$Util$second3, $author$project$Model$Card$suitMetadata);
var $author$project$Model$Card$cardToSuitOrder = function (card) {
	var suit = card.suit;
	var suitOrder = $author$project$Model$Card$suitToOrder(suit);
	var rankOrder = $author$project$Model$Card$cardToRankOrder(card);
	return (suitOrder * 10000) + rankOrder;
};
var $elm$core$List$sortBy = _List_sortBy;
var $author$project$Model$Card$sortHand = function (order) {
	var comparison = function () {
		if (order.$ === 'BySuit') {
			return $author$project$Model$Card$cardToSuitOrder;
		} else {
			return $author$project$Model$Card$cardToRankOrder;
		}
	}();
	return A2(
		$elm$core$Basics$composeL,
		$elm$core$List$reverse,
		$elm$core$List$sortBy(comparison));
};
...
var $author$project$Model$Deck$draw = F3(
	function (amount, sortOrder, original) {
		var hand = original.hand;
		var deck = original.deck;
		var newDeck = A2($elm$core$List$drop, amount, deck);
		var drawn = A2($elm$core$List$take, amount, deck);
		var newHand = A2($elm$core$List$append, hand, drawn);
		return _Utils_update(
			original,
			{
				deck: newDeck,
				hand: A2($author$project$Model$Card$sortHand, sortOrder, newHand)
			});
	});
var $elm$core$Basics$ge = _Utils_ge;
var $author$project$Model$Util$catMaybes = function (xs) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (mx, acc) {
...
var $author$project$Model$Deck$getHand = F2(
	function (selected, deck) {
		var cardPairs = A2(
			$elm$core$List$map,
			function (card) {
				return _Utils_Tuple2(card.id, card);
			},
			deck.hand);
		var handLookup = A2($edkv$elm_generic_dict$GenericDict$fromList, $TSFoster$elm_uuid$UUID$toString, cardPairs);
		return $author$project$Model$Util$catMaybes(
			A2(
				$elm$core$List$map,
				function (cardId) {
					return A3($edkv$elm_generic_dict$GenericDict$get, $TSFoster$elm_uuid$UUID$toString, cardId, handLookup);
				},
				$Gizra$elm_all_set$EverySet$toList(selected)));
	});
var $elm$core$List$sum = function (numbers) {
	return A3($elm$core$List$foldl, $elm$core$Basics$add, 0, numbers);
};
var $author$project$Model$Scoring$getChipsInHand = function (hand) {
	return $elm$core$List$sum(
		A2(
			$elm$core$List$map,
			function (_v0) {
				var rank = _v0.rank;
				return $author$project$Model$Card$rankToChips(rank);
			},
			hand));
};
var $author$project$Model$Scoring$getScoreInfoForKind = function (kind) {
	switch (kind.$) {
		case 'HighCard':
			return {baseChips: 5, baseMult: 1};
		case 'Pair':
			return {baseChips: 10, baseMult: 2};
		case 'TwoPair':
			return {baseChips: 20, baseMult: 2};
		case 'ThreeOfAKind':
			return {baseChips: 30, baseMult: 3};
		case 'Straight':
			return {baseChips: 30, baseMult: 4};
		case 'Flush':
			return {baseChips: 35, baseMult: 4};
		case 'FullHouse':
			return {baseChips: 40, baseMult: 4};
		case 'FourOfAKind':
			return {baseChips: 60, baseMult: 7};
		case 'StraightFlush':
			return {baseChips: 100, baseMult: 8};
		default:
			return {baseChips: 100, baseMult: 8};
	}
};
var $author$project$Model$Scoring$evalRules = F2(
	function (rules, hand) {
		return A3(
			$elm$core$List$foldl,
			F2(
...
var $author$project$Model$Scoring$Flush = {$: 'Flush'};
...
var $author$project$Model$Scoring$boolToMaybe = F2(
	function (value, a) {
		return value ? $elm$core$Maybe$Just(a) : $elm$core$Maybe$Nothing;
	});
var $author$project$Model$Util$groupByKey = F3(
	function (getKey, keyToString, elems) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (_v0, acc) {
					var key = _v0.a;
					var elem = _v0.b;
					var _v1 = A3($edkv$elm_generic_dict$GenericDict$get, keyToString, key, acc);
					if (_v1.$ === 'Nothing') {
						return A4(
							$edkv$elm_generic_dict$GenericDict$insert,
							keyToString,
							key,
							_List_fromArray(
								[elem]),
...
var $author$project$Model$Util$first3 = function (_v0) {
	var a = _v0.a;
	return a;
};
var $author$project$Model$Card$suitToString = A2($elm$core$Basics$composeL, $author$project$Model$Util$first3, $author$project$Model$Card$suitMetadata);
var $author$project$Model$Scoring$groupBySuit = A2(
	$author$project$Model$Util$groupByKey,
	function (_v0) {
		var suit = _v0.suit;
		return suit;
	},
	$author$project$Model$Card$suitToString);
...
var $author$project$Model$Scoring$parseFlush = function (hand) {
	var suitCounts = A2(
		$elm$core$List$map,
		A2($elm$core$Basics$composeL, $elm$core$List$length, $elm$core$Tuple$second),
		$edkv$elm_generic_dict$GenericDict$toList(
			$author$project$Model$Scoring$groupBySuit(hand)));
	var isFlush = A2(
		$elm$core$List$any,
		function (x) {
			return x >= 5;
		...
		suitCounts);
	return A2(
		$author$project$Model$Scoring$boolToMaybe,
		isFlush,
		{kind: $author$project$Model$Scoring$Flush, scoringCards: hand});
};
var $author$project$Model$Scoring$FourOfAKind = {$: 'FourOfAKind'};
...
var $author$project$Model$Card$rankToString = A2($elm$core$Basics$composeL, $author$project$Model$Util$first3, $author$project$Model$Card$rankMetadata);
var $author$project$Model$Scoring$groupByRank = A2(
	$author$project$Model$Util$groupByKey,
	function (_v0) {
		var rank = _v0.rank;
		return rank;
	},
	$author$project$Model$Card$rankToString);
var $author$project$Model$Scoring$groupsOfRank = F2(
	function (n, hand) {
		return A2(
			$elm$core$List$map,
			$elm$core$Tuple$second,
			A2(
				...
				A2(
					...
					$elm$core$Tuple$second),
				$edkv$elm_generic_dict$GenericDict$toList(
					$author$project$Model$Scoring$groupByRank(hand))));
	});
...
var $author$project$Model$Scoring$firstGroupOfRank = F2(
	function (n, hand) {
		return $elm$core$List$head(
			A2($author$project$Model$Scoring$groupsOfRank, n, hand));
	});
var $author$project$Model$Scoring$parseNOfKind = F3(
	function (n, kind, hand) {
		return A2(
			$elm$core$Maybe$map,
			function (group) {
				return {kind: kind, scoringCards: group};
			},
			A2($author$project$Model$Scoring$firstGroupOfRank, n, hand));
	});
var $author$project$Model$Scoring$parseFourOfAKind = A2($author$project$Model$Scoring$parseNOfKind, 4, $author$project$Model$Scoring$FourOfAKind);
var $author$project$Model$Scoring$FullHouse = {$: 'FullHouse'};
...
var $author$project$Model$Scoring$parseFullHouse = function (hand) {
	var makeScoringHand = F2(
		function (pair, toak) {
			return {
				kind: $author$project$Model$Scoring$FullHouse,
				scoringCards: _Utils_ap(pair, toak)
			};
		});
	var mToak = A2($author$project$Model$Scoring$firstGroupOfRank, 3, hand);
	var mPair = A2($author$project$Model$Scoring$firstGroupOfRank, 2, hand);
	return A3($elm$core$Maybe$map2, makeScoringHand, mPair, mToak);
};
var $author$project$Model$Scoring$HighCard = {$: 'HighCard'};
var $author$project$Model$Scoring$parseHighCard = function (hand) {
	var mHighCard = $elm$core$List$head(
		A2($author$project$Model$Card$sortHand, $author$project$Model$Card$ByRank, hand));
	return A2(
		$elm$core$Maybe$map,
		function (card) {
			return {
				kind: $author$project$Model$Scoring$HighCard,
				scoringCards: _List_fromArray(
					[card])
			};
		},
		mHighCard);
};
var $author$project$Model$Scoring$Pair = {$: 'Pair'};
var $author$project$Model$Scoring$parsePair = A2($author$project$Model$Scoring$parseNOfKind, 2, $author$project$Model$Scoring$Pair);
var $author$project$Model$Scoring$RoyalFlush = {$: 'RoyalFlush'};
var $author$project$Model$Util$isJust = function (ma) {
	if (ma.$ === 'Nothing') {
		return false;
	} else {
		return true;
...
var $author$project$Model$Scoring$evalPredicate = function (predicate) {
	return A2($elm$core$Basics$composeL, $author$project$Model$Util$isJust, predicate);
};
var $author$project$Model$Scoring$parseRoyalFlush = function (hand) {
	var sortedOrder = A2(
		$elm$core$List$map,
		function (_v0) {
			var rank = _v0.rank;
		...
		A2($author$project$Model$Card$sortHand, $author$project$Model$Card$ByRank, hand));
	var isRoyalStraight = _Utils_eq(
		sortedOrder,
		_List_fromArray(
			[$author$project$Model$Card$Ace, $author$project$Model$Card$King, $author$project$Model$Card$Queen, $author$project$Model$Card$Jack, $author$project$Model$Card$Ten]));
	var isFlush = A2($author$project$Model$Scoring$evalPredicate, $author$project$Model$Scoring$parseFlush, hand);
	return A2(
		$author$project$Model$Scoring$boolToMaybe,
		isFlush && isRoyalStraight,
		{kind: $author$project$Model$Scoring$RoyalFlush, scoringCards: hand});
};
var $author$project$Model$Scoring$Straight = {$: 'Straight'};
...
var $author$project$Model$Util$zip = $elm$core$List$map2($elm$core$Tuple$pair);
var $author$project$Model$Util$forwardDifference = function (values) {
	var shifted = A2($elm$core$List$drop, 1, values);
	var zipped = A2($author$project$Model$Util$zip, values, shifted);
	return A2(
		$elm$core$List$map,
		function (_v0) {
			var a = _v0.a;
...
var $author$project$Model$Scoring$parseStraight = function (hand) {
	var sortedRanks = A2(
		$elm$core$List$map,
		function (_v0) {
			var rank = _v0.rank;
		...
		A2($author$project$Model$Card$sortHand, $author$project$Model$Card$ByRank, hand));
	var isLowStraight = _Utils_eq(
		sortedRanks,
		_List_fromArray(
			[$author$project$Model$Card$Ace, $author$project$Model$Card$Five, $author$project$Model$Card$Four, $author$project$Model$Card$Three, $author$project$Model$Card$Two]));
	var isHighStraight = _Utils_eq(
		sortedRanks,
		_List_fromArray(
			[$author$project$Model$Card$Ace, $author$project$Model$Card$King, $author$project$Model$Card$Queen, $author$project$Model$Card$Jack, $author$project$Model$Card$Ten]));
	var handLength = $elm$core$List$length(hand);
	var differences = $author$project$Model$Util$forwardDifference(
		A2($elm$core$List$map, $author$project$Model$Card$rankToOrder, sortedRanks));
	var isStraight = (handLength === 5) && (A2(
		$elm$core$List$all,
		$elm$core$Basics$eq(1),
		differences) || (isHighStraight || isLowStraight));
	return A2(
		$author$project$Model$Scoring$boolToMaybe,
		isStraight,
		{kind: $author$project$Model$Scoring$Straight, scoringCards: hand});
};
var $author$project$Model$Scoring$StraightFlush = {$: 'StraightFlush'};
var $author$project$Model$Scoring$parseStraightFlush = function (hand) {
	var isStraight = A2($author$project$Model$Scoring$evalPredicate, $author$project$Model$Scoring$parseStraight, hand);
	var isFlush = A2($author$project$Model$Scoring$evalPredicate, $author$project$Model$Scoring$parseFlush, hand);
	return A2(
		$author$project$Model$Scoring$boolToMaybe,
		isStraight && isFlush,
		{kind: $author$project$Model$Scoring$StraightFlush, scoringCards: hand});
};
var $author$project$Model$Scoring$ThreeOfAKind = {$: 'ThreeOfAKind'};
var $author$project$Model$Scoring$parseThreeOfAKind = A2($author$project$Model$Scoring$parseNOfKind, 3, $author$project$Model$Scoring$ThreeOfAKind);
var $author$project$Model$Scoring$TwoPair = {$: 'TwoPair'};
var $author$project$Model$Scoring$parseTwoPair = function (hand) {
	var pairs = A2(
		$elm$core$List$take,
		2,
		A2($author$project$Model$Scoring$groupsOfRank, 2, hand));
	var isPair = $elm$core$List$length(pairs) === 2;
	return A2(
		$author$project$Model$Scoring$boolToMaybe,
		isPair,
		{
			kind: $author$project$Model$Scoring$TwoPair,
			scoringCards: $elm$core$List$concat(pairs)
		});
};
var $author$project$Model$Scoring$scoringRules = _List_fromArray(
	[$author$project$Model$Scoring$parseRoyalFlush, $author$project$Model$Scoring$parseStraightFlush, $author$project$Model$Scoring$parseFourOfAKind, $author$project$Model$Scoring$parseFullHouse, $author$project$Model$Scoring$parseFlush, $author$project$Model$Scoring$parseStraight, $author$project$Model$Scoring$parseThreeOfAKind, $author$project$Model$Scoring$parseTwoPair, $author$project$Model$Scoring$parsePair, $author$project$Model$Scoring$parseHighCard]);
var $author$project$Model$Scoring$parseHand = $author$project$Model$Scoring$evalRules($author$project$Model$Scoring$scoringRules);
var $author$project$Model$Scoring$getHandScore = function (hand) {
	var _v0 = $author$project$Model$Scoring$parseHand(hand);
	if (_v0.$ === 'Nothing') {
		return 0;
	} else {
		var kind = _v0.a.kind;
		var scoringCards = _v0.a.scoringCards;
		var chipsInHand = $author$project$Model$Scoring$getChipsInHand(scoringCards);
		var _v1 = $author$project$Model$Scoring$getScoreInfoForKind(kind);
		var baseChips = _v1.baseChips;
		var baseMult = _v1.baseMult;
		return (baseChips + chipsInHand) * baseMult;
	}
};
...
var $author$project$Main$msgTask = function (msg) {
	return A2(
		$elm$core$Task$perform,
...
var $author$project$Model$Deck$shuffle = function (original) {
	var deck = original.deck;
	return A2(
		$elm$random$Random$map,
		function (shuffled) {
...
var $author$project$Model$Deck$sort = F2(
	function (sortOrder, original) {
		var hand = original.hand;
		return _Utils_update(
			original,
			{
				hand: A2($author$project$Model$Card$sortHand, sortOrder, hand)
			});
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ToggleCardSelected':
				var cardId = msg.a;
				var isSelected = A2($Gizra$elm_all_set$EverySet$member, cardId, model.selected);
				var amountSelected = $Gizra$elm_all_set$EverySet$size(model.selected);
				var modify = function () {
					var _v1 = _Utils_Tuple2(isSelected, amountSelected >= 5);
					if (_v1.a) {
						return $Gizra$elm_all_set$EverySet$remove;
					} else {
						if (!_v1.b) {
							return $Gizra$elm_all_set$EverySet$insert;
						} else {
							return function (_v2) {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selected: A2(modify, cardId, model.selected)
						}),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							deck: A2(
								$elm$core$Maybe$map,
								A2($author$project$Model$Deck$draw, cards, model.sortOrder),
								model.deck)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Sort':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							deck: A2(
								$elm$core$Maybe$map,
								$author$project$Model$Deck$sort(sortOrder),
								model.deck),
							sortOrder: sortOrder
						}),
					$elm$core$Platform$Cmd$none);
			case 'Discard':
				var _v3 = _Utils_Tuple3(
					model.deck,
					model.discards,
					$Gizra$elm_all_set$EverySet$size(model.selected));
				_v3$0:
				while (true) {
					if (_v3.a.$ === 'Nothing') {
						if (!_v3.c) {
							...
							if (!_v3.b) {
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											deck: $elm$core$Maybe$Just(
												A2($author$project$Model$Deck$discard, model.selected, deck)),
											discards: discards - 1,
											selected: $Gizra$elm_all_set$EverySet$empty
										}),
									$author$project$Main$msgTask(
			...
			case 'PlayHand':
					...
					if (_v5.a.$ === 'Nothing') {
						...
						if (!_v5.c) {
							...
							if (!_v5.b) {
								...
								var deck = _v5.a.a;
								var hands = _v5.b;
								var score = $author$project$Model$Scoring$getHandScore(
									A2($author$project$Model$Deck$getHand, model.selected, deck));
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
				...
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'GenerateDeck':
				return _Utils_Tuple2(model, $author$project$Main$generateDeck);
			case 'DeckGenerated':
				var deck = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							deck: $elm$core$Maybe$Just(deck)
						}),
					$author$project$Main$msgTask($author$project$Main$Shuffle));
			case 'Shuffle':
				var _v7 = model.deck;
				if (_v7.$ === 'Nothing') {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					...
					return _Utils_Tuple2(
						...
						A2(
							...
							$author$project$Model$Deck$shuffle(deck)));
				}
			default:
				var newDeck = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							deck: $elm$core$Maybe$Just(newDeck)
						}),
					$author$project$Main$msgTask(
						$author$project$Main$Draw(8)));
		}
	});
...
var $author$project$Style$Colors$bg = A3($rtfeldman$elm_css$Css$rgb, 40, 40, 40);
...
var $author$project$Style$Colors$fg = A3($rtfeldman$elm_css$Css$rgb, 251, 241, 199);
var $rtfeldman$elm_css$Css$fontSize = $rtfeldman$elm_css$Css$prop1('font-size');
var $author$project$Style$Colors$green = A3($rtfeldman$elm_css$Css$rgb, 184, 187, 38);
...
var $author$project$Main$endResult = function (model) {
	var hasWon = _Utils_cmp(model.roundScore, model.scoreToBeat) > -1;
	var hasLost = (!model.hands) && (!hasWon);
	var show = hasWon || hasLost;
	var _v0 = hasWon ? _Utils_Tuple2('You Win!', $author$project$Style$Colors$green) : (hasLost ? _Utils_Tuple2('You Lost...', $author$project$Style$Colors$red) : _Utils_Tuple2('', $author$project$Style$Colors$fg));
	var message = _v0.a;
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$color(messageColor),
						$rtfeldman$elm_css$Css$marginBottom(
						$rtfeldman$elm_css$Css$px(50)),
						show ? $rtfeldman$elm_css$Css$display($rtfeldman$elm_css$Css$block) : $rtfeldman$elm_css$Css$display($rtfeldman$elm_css$Css$none)
					]))
			]),
		_List_fromArray(
			[
...
var $author$project$Model$Card$aceOfSuit = function (suit) {
	var ace = function () {
		switch (suit.$) {
			case 'Spade':
				return _Utils_chr('🂡');
	...
	return $elm$core$Char$toCode(ace);
};
var $elm$core$Char$fromCode = _Char_fromCode;
var $author$project$Model$Card$knightOfSuit = function (suit) {
	var ace = function () {
		switch (suit.$) {
			case 'Spade':
				return _Utils_chr('🂬');
...
var $author$project$Model$Card$skipKnight = F2(
	function (suit, code) {
		var knightCode = $author$project$Model$Card$knightOfSuit(suit);
		var skip = (_Utils_cmp(code, knightCode) > -1) ? 1 : 0;
		return code + skip;
	});
var $author$project$Model$Card$cardToUnicode = function (_v0) {
	var suit = _v0.suit;
	var rank = _v0.rank;
	var _v1 = $author$project$Model$Card$rankMetadata(rank);
	var rankOrder = _v1.b;
	return $elm$core$String$fromChar(
		$elm$core$Char$fromCode(
			A2(
				$author$project$Model$Card$skipKnight,
				suit,
				$author$project$Model$Card$aceOfSuit(suit) + rankOrder)));
};
...
var $author$project$Model$Card$suitToColor = A2($elm$core$Basics$composeL, $author$project$Model$Util$third3, $author$project$Model$Card$suitMetadata);
...
var $author$project$Main$cardElement = F3(
	function (msg, selected, card) {
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							selected ? $rtfeldman$elm_css$Css$px(70) : $rtfeldman$elm_css$Css$px(30))
						]))
				]),
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Model$Card$suitToColor(card.suit)),
					...
					_List_fromArray(
						[
							...
							$author$project$Model$Card$cardToUnicode(card))
						]))
				]));
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Css$px(0),
							$rtfeldman$elm_css$Css$px(10),
							$author$project$Style$Colors$bg)
						]))
				]),
			A2(
				$elm$core$List$map,
				function (card) {
					return A3(
						...
						$author$project$Main$ToggleCardSelected(card.id),
						isSelected(card),
						card);
				},
				deck.hand));
...
var $author$project$Model$Card$BySuit = {$: 'BySuit'};
var $author$project$Main$Discard = {$: 'Discard'};
var $author$project$Main$PlayHand = {$: 'PlayHand'};
...
var $author$project$Main$playerControls = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A4(
				$author$project$Main$bigButton,
				'Play Hand',
				$author$project$Style$Colors$blue,
				$author$project$Main$PlayHand,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Sort Hand')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							...
							[
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													['Balatro'])),
												$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$Colors$yellowDim),
												$rtfeldman$elm_css$Css$border(
												$rtfeldman$elm_css$Css$px(0)),
												$rtfeldman$elm_css$Css$borderRadius(
												$rtfeldman$elm_css$Css$px(5)),
										...
										$author$project$Main$Sort($author$project$Model$Card$ByRank))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Html$Styled$Events$onClick(
										$author$project$Main$Sort($author$project$Model$Card$BySuit))
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Suit')
									]))
							]))
					])),
				A4(
				$author$project$Main$bigButton,
				'Discard',
				$author$project$Style$Colors$red,
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$width(
								$rtfeldman$elm_css$Css$pct(100)),
								$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$Colors$blue),
								$rtfeldman$elm_css$Css$height(
								$rtfeldman$elm_css$Css$px(50)),
								$rtfeldman$elm_css$Css$margin(
								$rtfeldman$elm_css$Css$px(10)),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A3(
										$rtfeldman$elm_css$Css$textShadow3,
										$rtfeldman$elm_css$Css$px(2),
										$rtfeldman$elm_css$Css$px(2),
										$author$project$Style$Colors$bg2),
										$rtfeldman$elm_css$Css$fontWeight($rtfeldman$elm_css$Css$bold)
									]))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Small Blind')
							]))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$width(
								$rtfeldman$elm_css$Css$pct(100)),
								$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$Colors$blueDim),
								$rtfeldman$elm_css$Css$height(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Small')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$span,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Blind')
									]))
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$Colors$bg3),
										$rtfeldman$elm_css$Css$width(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Score at least')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$span,
								_List_Nil,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(
										'⛀ ' + $elm$core$String$fromInt(model.scoreToBeat))
									]))
							]))
					]))
			]));
...
var $author$project$Model$Scoring$handKindToString = function (mHandKind) {
	if (mHandKind.$ === 'Nothing') {
		return '';
	} else {
		var handKind = mHandKind.a;
		switch (handKind.$) {
			case 'HighCard':
				return 'High Card';
			case 'Pair':
...
var $author$project$Style$Colors$redDim = A3($rtfeldman$elm_css$Css$rgb, 204, 36, 18);
var $author$project$Main$handScoreDisplay = function (model) {
	var mHand = A2(
		$elm$core$Maybe$map,
		$author$project$Model$Deck$getHand(model.selected),
		model.deck);
	var mHandKind = A2(
		$elm$core$Maybe$map,
		function (_v1) {
		...
		A2($elm$core$Maybe$andThen, $author$project$Model$Scoring$parseHand, mHand));
	var _v0 = A2(
		$elm$core$Maybe$withDefault,
		{baseChips: 0, baseMult: 0},
		A2($elm$core$Maybe$map, $author$project$Model$Scoring$getScoreInfoForKind, mHandKind));
	var baseChips = _v0.baseChips;
	var baseMult = _v0.baseMult;
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$width(
						$rtfeldman$elm_css$Css$pct(100)),
						$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$Colors$bg),
						$rtfeldman$elm_css$Css$margin(
						$rtfeldman$elm_css$Css$px(10)),
						$rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
						$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(
						$author$project$Model$Scoring$handKindToString(mHandKind))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(
										$elm$core$String$fromInt(baseChips))
									]))
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$span,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Css$color($author$project$Style$Colors$redDim),
										$rtfeldman$elm_css$Css$margin(
										$rtfeldman$elm_css$Css$px(10))
									]))
							]),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Css$displayFlex,
										$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$Colors$redDim),
										$rtfeldman$elm_css$Css$width(
										$rtfeldman$elm_css$Css$pct(30)),
										$rtfeldman$elm_css$Css$borderRadius(
										$rtfeldman$elm_css$Css$px(5)),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(
										$elm$core$String$fromInt(baseMult))
									]))
							]))
					]))
			]));
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(
						'⛀ ' + $elm$core$String$fromInt(model.roundScore))
					]))
			]));
};
...
var $author$project$Main$runInfo = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$blindInfo(model),
				$author$project$Main$roundScoreDisplay(model),
				$author$project$Main$handScoreDisplay(model),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$runInfo(model),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Main$endResult(model),
										$author$project$Main$handElement(model),
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$href('src/fonts.css'),
